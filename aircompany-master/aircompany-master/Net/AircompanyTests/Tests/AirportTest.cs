...
namespace AircompanyTests.Tests
{
    ...
    public class AirportTest
    {
        ...
        [Test]
        public void MilitaryPlaneTypeIsTransportTest()
        {
            Airport airport = new Airport(planes);
            List<MilitaryPlane> transportMilitaryPlanes = airport.GetTransportMilitaryPlanes().ToList();
            Assert.IsTrue(transportMilitaryPlanes.Where(t => t.PlaneTypeIs() == MilitaryType.TRANSPORT).Any());
        }

        [Test]
        public void CorrectPassengerPlaneWithMaxPassengersCapacityTest()
        {
            Airport airport = new Airport(planes);
        ...
        [Test]
        public void SortByMaxLoadCapacityWorkTest()
        {
            Airport airport = new Airport(planes);
            ...
            Assert.AreEqual(planesSortedByMaxLoadCapacity, airport.Planes.OrderBy(t => t.MAXLoadCapacity()));
        }
    }
}
